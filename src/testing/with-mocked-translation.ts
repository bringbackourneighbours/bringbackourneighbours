...
const uiTranslationMock = (lang: string): { data: InferEntrySchema<'ui'> } => ({
  data: {
    meta: {
      ...
      copy: `${lang}-copy`,
      downloadAllFlyerPdf: `${lang}-downloadAllFlyerPdf`,
      downloadAllZinePdf: `${lang}-downloadAllZinePdf`,
      downloadPdf: `${lang}-downloadPdf`,
      emergencyKit: `${lang}-emergencyKit`,
      findAlsoAsFlyerInFallbackLang: `${lang}-findAlsoAsFlyerInFallbackLang`,
      findAlsoAsPage: `${lang}-findAlsoAsPage`,
      findAlsoAsPageInFallbackLang: `${lang}-findAlsoAsPageInFallbackLang`,
