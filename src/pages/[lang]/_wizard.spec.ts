...
test.describe('pages/[lang]/wizard', () => {
  test('de', async ({ page }) => {
    await page.goto('/de/wizard');
    ...
    await expect(page.locator('body')).toMatchAriaSnapshot(`
      ...
      - main:
        - navigation:
          - button "Deutsch":
            - img
        - link "Du bist selber von einer Abschiebung bedroht?":
          - /url: http://localhost:4321/de/kit/affected/Notfallkoffer%20gegen%20Abschiebungen%20f%C3%BCr%20Betroffene
        - link "Du möchtest eine Person unterstützen, die von Abschiebung bedroht ist?":
    ...
    await expect(page.locator('body')).toMatchAriaSnapshot(`
      ...
      - main:
        - navigation:
          - button "english":
            - img
        - link "Are you yourself at risk of deportation?":
        ...
        - link "Would you like to support a person who is at risk of deportation?":
