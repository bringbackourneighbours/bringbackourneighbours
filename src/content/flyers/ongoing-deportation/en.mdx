...
<ExternalShortLink
  identifier="noboarderassembly_resistance"></ExternalShortLink>Think about what is better for you and your family: would you rather survive the deportation as quickly as possible and experience as little violence as possible? Or do you want to try everything you can to gain time to have one last chance to prevent the deportation?
Please note: If you put up a strong defence and thus prevent deportation, you may end up in <InternalShortLink
  identifier="detention">detention pending deportation</InternalShortLink> and be separated from your family.
