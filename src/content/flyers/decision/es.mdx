---
identifier: decision
title: Decisiones negativas en el procedimiento de asilo
lang: es
machineTranslation: true
seo: Decisiones negativas en el procedimiento de asilo
...
Para los rechazos de Dublín y una segunda solicitud de asilo "Folgeantrag". Encontrará más información sobre el procedimiento de Dublín aquí: <InternalShortLink identifier="dublin" /> <br/>
Un rechazo como inadmisible significa que no se examinan a fondo sus motivos para la solicitud de asilo y que Alemania no considera necesaria la solicitud de asilo. <br/>
...
La decisión del BAMF dice: Su solicitud de asilo es rechazada. <br/>
...
El sistema de asilo alemán es muy complicado, por lo que no es posible resumir toda la información en un breve folleto. Utilice también la información adicional de nuestro folleto: <InternalShortLink identifier="procedure"/>
...
Si quiere irse de Alemania, puede solicitar una ayuda. Aquí encontrará más información en diferentes idiomas.
