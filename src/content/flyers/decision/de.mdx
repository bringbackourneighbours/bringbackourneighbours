...
Das deutsche Asylsystem ist sehr kompliziert, sodass es nicht möglich ist, alle Informationen in einem kurzen Flyer zusammenzufassen. Bitte nutze die weiteren Informationen in unseren Flyern, um dich zu informieren und nutze auch Workshops für Geflüchtete und Ehrenamtliche, in denen das deutsche Asylsystem erklärt wird.
