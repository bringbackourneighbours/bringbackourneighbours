...
- If you like, sign the <InternalShortLink identifier="forms">templates</InternalShortLink> from this emergency kit and give them to someone you trust. They can then react quickly in the event of deportation if you run out of time.

There is further <InternalShortLink identifier="supporters">information for supporters</InternalShortLink>, where you can find <InternalShortLink identifier="contacts">contacts</InternalShortLink> to authorities and courts or politicians. They can call supporters for you if you are deported.
