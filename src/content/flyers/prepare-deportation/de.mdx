...
- Wenn du magst, unterschreibe die <InternalShortLink identifier="forms">Vorlagen</InternalShortLink> aus diesem Notfallkoffer und gib sie einer Person, der du vertraust. Sie kann dann bei einer Abschiebung schnell reagieren, wenn du keine Zeit mehr hast.

Es gibt einen weiteren <InternalShortLink identifier="support">Notfallkoffer für Unterstützer\*innen</InternalShortLink>. Hier gibt es <InternalShortLink identifier="contacts">Kontakte</InternalShortLink> zu Behörden und Gerichten oder Politiker\*innen. Diese können Unterstützer\*innen für dich anrufen, wenn du abgeschoben wirst.
