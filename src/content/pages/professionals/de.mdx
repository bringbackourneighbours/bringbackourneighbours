...
- Kläre, ob tatsächlich vollziehbare Ausreisepflicht besteht und weise ggf. auf laufende Gerichtsverfahren hin (Aktenzeichen!). Die Polizei ist verpflichtet, den substanziierten Hinweisen, dass möglicherweise ein Irrtum vorliegt, nachzugehen. Sollten diese Hinweise vorliegen, kannst du auch die Landesdirektion als für die Abschiebung zuständige Behörde kontaktieren.
