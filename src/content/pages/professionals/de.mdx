...
Abschiebungen gefährden das Kindeswohl. In wenigen Fällen versucht die Polizei, trotzdem Kinder aus Schulen oder Kindertagesstätten abzuschieben. <ExternalShortLink identifier="leitfaden-schule-kita"></ExternalShortLink> .

Handreichung für Klinikpersonal des IPPNW zu Abschiebungen aus Kliniken:

<ExternalShortLink identifier="ippnw_klinik"></ExternalShortLink> .
