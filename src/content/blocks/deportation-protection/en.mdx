...
W2eu has written a brochure with important tips on how to stop deportations:

<ExternalShortLink identifier="w2eu-deportation" />

Multilingual information on resistance against deportations can also be found in the comic from OPlatz Berlin Refugee Movement:
